...
export default function CreateHostAccount() {
  ...
  const helperText = useMemo(() => params.get('email') ? 'Use the invited email from the link and the security key from your invite email.' : 'Enter the invited email address and the security key from your invite email.', [params])
