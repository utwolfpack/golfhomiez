...
export async function resolveMyLocationFromBrowser(): Promise<LocationOption | null> {
  ...
  return getNearestLocation(position.coords.latitude, position.coords.longitude)
}
