...
not ok 42 - host portal exposes tournament creation, portal listing, and organizer invite routes
  ---
  duration_ms: 5.4283
  location: 'file:///C:/SeanCode/GolfHomiez/golfhomiez/test/app.test.js:575:1'
  failureType: 'testCodeFailure'
  error: |-
    The input did not match the regular expression /listHostPortalTournaments\(db, account\)/. Input:
    ...
    "import 'dotenv/config'\r\n" +
      ...
      "    if (!adminUser) return res.status(401).json({ message: 'Admin authenticati"... 92698 more characters
  ...
  operator: 'match'
  stack: |-
    TestContext.<anonymous> (file:///C:/SeanCode/GolfHomiez/golfhomiez/test/app.test.js:578:10)
...
not ok 48 - published tournament registration uses resolved tournament id for foreign key inserts
  ---
  duration_ms: 1.0575
  location: 'file:///C:/SeanCode/GolfHomiez/golfhomiez/test/app.test.js:645:1'
  failureType: 'testCodeFailure'
  error: |-
    The input was expected to not match the regular expression /normalizeEmail\(req\.organizerUser\.email\)/. Input:
  ...
  stack: |-
    TestContext.<anonymous> (file:///C:/SeanCode/GolfHomiez/golfhomiez/test/app.test.js:651:10)
    Test.runInAsyncScope (node:async_hooks:206:9)
    Test.run (node:internal/test_runner/test:631:25)
    Test.processPendingSubtests (node:internal/test_runner/test:374:18)
    Test.postRun (node:internal/test_runner/test:715:19)
...
not ok 49 - host and organizer tournament tiles expose registered golfer counts and details
  ---
  duration_ms: 0.2249
  location: 'file:///C:/SeanCode/GolfHomiez/golfhomiez/test/app.test.js:654:1'
  failureType: 'testCodeFailure'
  error: 'path is not defined'
  code: 'ERR_TEST_FAILURE'
  name: 'ReferenceError'
  stack: |-
    TestContext.<anonymous> (file:///C:/SeanCode/GolfHomiez/golfhomiez/test/app.test.js:655:34)
    Test.runInAsyncScope (node:async_hooks:206:9)
    Test.run (node:internal/test_runner/test:631:25)
    Test.processPendingSubtests (node:internal/test_runner/test:374:18)
    Test.postRun (node:internal/test_runner/test:715:19)
...
not ok 50 - tournament registration sends confirmation email with tournament link
  ---
  duration_ms: 0.1766
  location: 'file:///C:/SeanCode/GolfHomiez/golfhomiez/test/app.test.js:669:1'
  failureType: 'testCodeFailure'
  error: 'path is not defined'
  code: 'ERR_TEST_FAILURE'
  name: 'ReferenceError'
  stack: |-
    TestContext.<anonymous> (file:///C:/SeanCode/GolfHomiez/golfhomiez/test/app.test.js:670:34)
    Test.runInAsyncScope (node:async_hooks:206:9)
    Test.run (node:internal/test_runner/test:631:25)
    Test.processPendingSubtests (node:internal/test_runner/test:374:18)
    Test.postRun (node:internal/test_runner/test:715:19)
...
not ok 53 - server blocks duplicate tournament registration instead of upserting existing rows
  ---
  duration_ms: 2.1392
  location: 'file:///C:/SeanCode/GolfHomiez/golfhomiez/test/app.test.js:705:1'
  failureType: 'testCodeFailure'
  error: |-
    The input was expected to not match the regular expression /ON DUPLICATE KEY UPDATE[\s\S]*tournament_registration_completed/. Input:
  ...
  operator: 'doesNotMatch'
  stack: |-
    TestContext.<anonymous> (file:///C:/SeanCode/GolfHomiez/golfhomiez/test/app.test.js:711:10)
    Test.runInAsyncScope (node:async_hooks:206:9)
    Test.run (node:internal/test_runner/test:631:25)
    Test.processPendingSubtests (node:internal/test_runner/test:374:18)
    Test.postRun (node:internal/test_runner/test:715:19)
...
ok 55 - one-time schema rollback is wired into postinstall and removes itself afterward
  ---
  duration_ms: 4.4725
  ...
# Subtest: rollback migration removes chat-added schema tables and migration records
ok 56 - rollback migration removes chat-added schema tables and migration records
  ---
  duration_ms: 3.2812
  ...
1..56
