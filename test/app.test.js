...
test('tournament flyer template is persisted, editable, and supports organizer-provided imagery and fields', () => {
  ...
  assert.match(templateFields, /readAsDataURL/)
  ...
  assert.match(tournamentPortal, /Sponsor Logos/)
  assert.doesNotMatch(tournamentPortal, /detailLinesImageUrl|Tournament flyer detail lines|backgroundImage|aspectRatio: '626 \/ 292'|left: '60\.5%'/)
