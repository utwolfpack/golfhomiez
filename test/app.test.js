...
test('the package test script targets the maintained test suite files', () => {
  ...
  assert.equal(pkg.scripts.test, 'node --test test/app.test.js test/migration-compatibility.test.js test/schema-backup.test.js test/schema-rollback.test.js test/dependency-security.test.js')
})
...
test('golf user inbox supports messages, Team Challenges, unread indicators, invite fallback, migrations, and logging', () => {
  ...
  assert.match(challengesPage, /isChallengeActive/)
  assert.match(challengesPage, /sortChallengeThreadsByActiveStatus/)
...
test('registered tournaments support team score entry with a clickable non-consolidated tournament leaderboard', () => {
  ...
  assert.match(tournaments, /<PageHero title="My tournaments" \/>/)
