...
test('golf user inbox supports messages, Team Challenges, unread indicators, invite fallback, migrations, and logging', () => {
  ...
  assert.match(nav, /fetchInboxSummary/)
  assert.match(nav, /inboxNavIndicator/)
  assert.match(nav, /to="\/inbox"/)
  assert.match(nav, /Challenges &amp; Messages/)
  assert.match(inboxPage, /Recipient email/)
  assert.match(inboxPage, /Team Challenge/)
  assert.match(inboxPage, /Team to Challenge/)
  assert.match(inboxPage, /teamChallengeDate/)
  assert.match(inboxPage, /teamChallengeState/)
  assert.match(inboxPage, /teamChallengeCourse/)
  assert.match(inboxPage, /UseMyLocationButton/)
  assert.match(inboxPage, /US_STATES/)
  assert.match(inboxPage, /\/api\/golf-courses\?state=/)
  assert.match(inboxPage, /Your team/)
  assert.match(inboxPage, /fetchTeams/)
  assert.match(inboxPage, /teamChallengeOptions/)
  assert.match(inboxPage, /Team search is not case-sensitive/)
  assert.match(inboxPage, /TeamNotFoundError/)
  assert.match(inboxPage, /Team does not exist/)
  assert.doesNotMatch(inboxPage, /Challenge request/)
  assert.match(inboxPage, /Your message was sent successfully\./)
  assert.match(inboxPage, /RecipientNotFoundError/)
  assert.match(inboxPage, /navigate\(`\/invite-homie\?email=/)
  assert.match(inboxPage, /inbox_send_started/)
  assert.match(inboxPage, /inbox_send_succeeded/)
  assert.match(inboxPage, /inbox_thread_marked_read/)
  assert.match(inboxPage, /<h2 className="inboxSectionTitle">Messages<\/h2>/)
  assert.match(inboxPage, /<h2 className="inboxSectionTitle">Send a Message<\/h2>/)
  assert.match(inboxPage, /<h2 className="inboxSectionTitle">Challenges<\/h2>/)
  assert.match(inboxPage, /challengeType/)
  assert.match(inboxPage, /Individual Challenge/)
  assert.match(inboxPage, /individualParticipantEmails/)
  assert.match(inboxPage, /parsedIndividualParticipantEmails\.length\}\/25 golfers entered/)
  assert.match(inboxPage, /renderIndividualChallengeScores/)
  assert.match(inboxPage, /Save Individual Challenge Score/)
  assert.match(inboxPage, /Only you can edit your Individual Challenge score\./)
  assert.match(inboxPage, /Leaderboard/)
  assert.match(inboxPage, /renderIndividualChallengeLeaderboardModal/)
  assert.match(inboxPage, /inboxLeaderboardModal/)
  assert.match(inboxPage, /Individual Challenge Leaderboard/)
  assert.match(inboxPage, /individual_challenge_leaderboard_opened/)
  assert.doesNotMatch(inboxPage, /Unread messages show an inbox indicator/)
  assert.doesNotMatch(inboxPage, /Read messages and Team Challenges from other Golf Homiez users/)
  assert.match(inboxPage, /buildInboxThreads/)
  assert.match(inboxPage, /receivedThreads/)
  assert.match(inboxPage, /expandedThreadId/)
  assert.match(inboxPage, /aria-expanded=\{isExpanded\}/)
  assert.match(inboxPage, /inboxMessagePreview/)
  assert.match(inboxPage, /inbox_thread_expanded/)
  assert.match(inboxPage, /inbox_thread_collapsed/)
  assert.doesNotMatch(inboxPage, /<h2 className="inboxSectionTitle">Sent messages<\/h2>/)
  assert.match(inboxPage, /Team Challenges/)
  assert.match(inboxPage, /messageOnlyMessages/)
  assert.match(inboxPage, /teamChallengeMessages/)
  assert.match(inboxPage, /teamChallengeThreads/)
  assert.match(inboxPage, /renderThreadCard\(thread, 'team-challenges'\)/)
  assert.match(inboxPage, /renderTeamChallengeScores/)
  assert.match(inboxPage, /Team Challenge Scores/)
  assert.match(inboxPage, /HoleByHoleScorecard/)
  assert.match(inboxPage, /teamScorecardInputButton/)
  assert.match(inboxPage, /Tap to enter score/)
  assert.match(inboxPage, /Save Team Challenge Score/)
  assert.match(inboxPage, /Opponent team score is read-only/)
  assert.match(inboxPage, /Team Challenge score saved\./)
  assert.doesNotMatch(inboxPage, /Sent challenges/)
  assert.match(inboxPage, /replyToInboxMessage/)
  assert.match(inboxPage, /inbox_reply_started/)
  assert.match(inboxPage, /team_challenge_reply_started/)
  assert.match(inboxPage, /Accept Team Challenge/)
  assert.match(inboxPage, /updateTeamChallengeStatus/)
  assert.match(inboxPage, /Team Challenge accepted\. Team members can continue the dialogue in this thread\./)
  assert.match(inboxPage, /inboxConversationThread/)
  assert.match(inboxPage, /inboxTeamChallengeContext/)
  ...
  assert.match(css, /inboxSectionToggleButton/)
...
test('home and my golf scores use Team Challenges from inbox score records instead of Team Logger records for score filters', () => {
  ...
  assert.match(home, /to="\/inbox">Open Team Challenges/)
  ...
  assert.match(directions, /Inbox Team Challenges/)
  assert.doesNotMatch(directions, /Team Logger/)
  assert.match(teams, /Inbox Team Challenges/)
  ...
  assert.match(modal, /Team Challenge score record is maintained from the Inbox Team Challenges section/)
})
