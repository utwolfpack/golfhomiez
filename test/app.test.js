...
test('host auth flow adds direct host routes, invite redemption, and reset endpoints', () => {
  const server = fs.readFileSync(new URL('../server/index.js', import.meta.url), 'utf8')
  ...
  assert.match(hostRegister, /Create your golf-course account/)
  assert.match(hostRegister, /Security key/)
  assert.match(hostRegister, /Create golf-course account/)
