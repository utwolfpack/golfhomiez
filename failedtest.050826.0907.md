...
not ok 65 - organizer session lookup is collation-safe for stage schema differences
  ...
  error: |-
    The input did not match the regular expression /ALTER TABLE organizer_sessions MODIFY organizer_account_id VARCHAR\(64\) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL/. Input:
  ...
  operator: 'match'
  stack: |-
    TestContext.<anonymous> (file:///C:/SeanCode/GolfHomiez/golfhomiez/test/app.test.js:941:10)
